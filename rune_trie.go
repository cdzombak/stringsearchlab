...
// https://github.com/dghubble/trie/blob/master/rune_trie.go

// RuneTrie is a trieSearch of runes with string keys and interface{} values.
...
// Put inserts the value into the trieSearch at the given key, replacing any
...
// becomes childless as a result, it is removed from the trieSearch.
...
// Walk iterates over each key/value stored in the trieSearch and calls the given
